        ...
        <div className="w-full lg:w-[95%] shadow-lg mx-auto px-4 py-8">
            <div className="flex flex-col gap-10 lg:flex-row">
                ...
                <div className="flex-1 lg:pl-8">
                    <h1 className="text-[24px] lg:text-[30px] crimson tracking-wider mb-4">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="flex items-center gap-3 mt-2 cursor-pointer">
                            <div className="w-5 h-5 lg:w-6 lg:h-6 rounded-full bg-yellow-400 border-2 border-gray-500 transform transition-transform duration-300 hover:scale-125"></div>
                        </div>
                    </div>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="flex items-center gap-2 lg:gap-3 mt-2">
                            {["XS", "S", "M", "L", "XL", "XXL"].map((size) => (
                                <button
                                    key={size}
                                    className="px-2 py-1 lg:px-3 lg:py-1.5 text-xs lg:text-sm border rounded-md hover:bg-gray-100"
                                >
                                    {size}
                                </button>
                            ))}
                    ...
                    {/* Add to Cart */}
                    <button className="my-4 w-full bg-gradient-to-r from-[#1e381e] to-[#2b4f2b] text-white py-2 lg:py-3 rounded-md transform transition-all duration-300 hover:shadow-lg hover:from-[#2b4f2b] hover:to-[#1e381e] text-sm lg:text-base">
                        Add To Cart
                    </button>
                    <button className="w-full flex items-center justify-center gap-2 border border-transparent py-2 lg:py-3 rounded-md text-black transform transition-all duration-300 shadow-lg border-[#1e381e] text-sm lg:text-base">
                    ...
                    <div className="mt-6 border-t pt-4">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 mt-4 border p-4 justify-center border-gray-400">
                            <FaTruck />
