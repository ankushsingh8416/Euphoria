...
export default function FilterSection() {
  ...
  if (pathname === "/women") {
    filterOptions = {
      Category: ["Kurta Sets", "Sarees & Blouses", "Lehenga Sets", "Kaftans", "Gowns", "Dresses & Jumpsuits", "Co-Ord Sets"],
      Price: ["1000-10000", "10000-50000", "50000-100000", "100000-200000"],
      Color: ["Red", "Blue", "Green", "Yellow", "Pink", "Black", "White", "Beige", "Purple"],
      Size: ["XS", "S", "M", "L", "XL", "XXL"],
      Brand: ["FabIndia", "Biba", "W for Women", "Manish Malhotra", "Sabyasachi", "Ritu Kumar"],
    };
  } else if (pathname === "/men") {
    filterOptions = {
      Category: ["Kurtas & Shirts", "Sherwanis", "Bandhgalas", "Nehru Jackets", "Bottoms", "Blazers & Suits", "Casual Wear"],
      Price: ["1000-10000", "10000-50000", "50000-100000", "100000-200000"],
      Color: ["Red", "Blue", "Green", "Yellow", "Pink", "Black", "White", "Grey", "Brown"],
      Size: ["XS", "S", "M", "L", "XL", "XXL"],
      Brand: ["Raymond", "Peter England", "Louis Philippe", "Manyavar", "U.S. Polo Assn.", "Park Avenue"],
    };
  }
